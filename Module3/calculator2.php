...
//This function calculates the trip cost
//This function takes three arguments: distance, fuel efficiency, and price per gallon
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_POST['distance'], $_POST['gallon_price'], $_POST['efficiency']) &&
	 is_numeric($_POST['distance']) && is_numeric($_POST['gallon_price']) && is_numeric($_POST['efficiency']) ) {
		...
		/*'<div class="page-header"><h1>Total Estimated Cost</h1></div>
